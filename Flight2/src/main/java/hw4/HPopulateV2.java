 ...
 * Using BufferedMutator of size 20 mb,and rowKey of CarrierId-Year-Month-DayOfMonth-Flightnumber-Origin
 * @author csj
 *
 */
public class HPopulateV2 {
	public static final String HTABLE_NAME = "FlightData";
	public static final byte[] COLUMN_FAMILY = "Flight".getBytes();
	public static final byte[] COLUMN_YEAR = "yr".getBytes(); 
	public static final byte[] COLUMN_CANCELLED = "cancel".getBytes(); 
	public static final byte[] COLUMN_DELAY = "delay".getBytes(); 
	...
	public static class HPopulateMapper extends Mapper <LongWritable, Text, ImmutableBytesWritable, Writable> {
		...
		protected void setup(Context context) throws IOException  {
			...
			//BufferSize in byte, let set it 1 mb
			params.writeBufferSize( 1 * 1023 * 1024 );
		 ...
		 * rowKey of CarrierId-Year-Month-DayOfMonth-Flightnumber-Origin
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = Job.getInstance(config, "Populate HTable");
